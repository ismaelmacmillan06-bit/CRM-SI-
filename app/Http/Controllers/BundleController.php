...
class BundleController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'type'  => 'required|in:ELT,Plan Lector,Imagina,Wikids,Pienso Contigo,Complemento,Entrelineas,Palabrario,Frances,Ecosistemas,Praxis,Ekos,Carrousel',
        ]);
    ...
    public function importar(Request $request)
    {
        ...
        $tiposValidos = ['ELT', 'Plan Lector', 'Imagina', 'Wikids', 'Pienso Contigo', 'Complemento', 'Entrelineas', 'Palabrario', 'Frances', 'Ecosistemas', 'Praxis', 'Ekos', 'Carrousel'];
        $agregados    = 0;
        $duplicados   = 0;
        $omitidos     = [];
    ...
    public function plantilla()
    {
        ...
        $sheet->setCellValue('A9', 'Tipos válidos: ELT | Plan Lector | Imagina | Wikids | Pienso Contigo | Complemento | Entrelineas | Palabrario | Frances | Ecosistemas | Praxis | Ekos | Carrousel');
