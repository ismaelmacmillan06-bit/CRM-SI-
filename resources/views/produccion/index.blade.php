...
<style>
    ...
    .pd-combo-list { position:fixed; max-height:260px; overflow-y:auto;
        background:var(--surface); border:1px solid var(--border); border-radius:10px; box-shadow:0 8px 24px rgba(0,0,0,.15); z-index:1000; padding:6px; }
    ...
    (function () {
        ...
        function setupCombo({ inputEl, listEl, chipsEl, getOptions, formatOption, selectedSet, onChange }) {
            function renderList(query) {
                ...
                // position:fixed calculado en JS: así ningún contenedor padre
                // (con overflow:hidden o el que sea) puede recortar la lista.
